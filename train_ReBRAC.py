...
DEFAULT_ACTOR_BETA = 0.001
DEFAULT_CRITIC_BETA = 0.01
...
def main(args):
    ...
    rebrac.fit(dataset,
            ...
            experiment_name=f'ReBRAC_{ac_name}_{0}',
    )
...
if __name__ == '__main__':
    ...
    parser.add_argument('--actor_beta', type=float, default=DEFAULT_ACTOR_BETA)
    parser.add_argument('--critic_beta', type=float, default=DEFAULT_CRITIC_BETA)
